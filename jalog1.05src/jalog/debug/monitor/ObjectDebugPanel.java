package jalog.debug.monitor;

import jalog.debug.CustomCommand;
import jalog.debug.CustomCommandEntry;
import jalog.debug.DebugTable;
import jalog.debug.Debugable;
import jalog.debug.FullDebugable;
import jalog.debug.HistoryLog;
import jalog.debug.TraceControl;
import jalog.debug.TracePoint;
import jalog.jlog.main.ApiControl;
import jalog.util.AppProperties;
...
class ObjectDebugPanel extends JPanel {
   ...
   private void jbInit() throws Exception {
      ...
      ImageIcon objectIcon = getIcon("jalog/debug/monitor/green-ball.gif") ;
      ...
      ImageIcon optionIcon = getIcon("jalog/debug/monitor/blue-ball.gif") ;
      ImageIcon tableIcon = getIcon("jalog/debug/monitor/table1.gif") ;
      ImageIcon commandIcon = getIcon("jalog/debug/monitor/arrow.gif") ;
   ...
   private void initPopupMenu() {
      ...
      menuItem.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent event) {
            ...
            chooser.setSelectedFile(new File("jalogdump.zip"));
   ...
   /**
    * The serialVersionUID for the class jalog.debug.monitor.ObjectDebugPanel
