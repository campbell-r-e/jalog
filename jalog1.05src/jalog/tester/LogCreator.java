...
public class LogCreator {
   ...
   private LogEntry createLogEntry(int index) {
      ...
      logEntry.getContest().setReceivedSerialNumber(index + " rx serial number") ;
      logEntry.getContest().setTransmittedSerialNumber(index + " tx serial number") ;
