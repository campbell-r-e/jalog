...
public class Utility {
   ...
   /**
    * Returns the OS-appropriate user data directory for Jalog, creating it if necessary.
    * <ul>
    *   <li>Windows  — %APPDATA%\Jalog\</li>
    *   <li>macOS    — ~/Library/Application Support/Jalog/</li>
    *   <li>Linux    — $XDG_CONFIG_HOME/jalog/  (falls back to ~/.config/jalog/)</li>
    * </ul>
    *
    * @return the writable application data directory
    */
   static public File getAppDataDir() {
      String os   = System.getProperty("os.name", "").toLowerCase();
      String home = System.getProperty("user.home");
      File dir;
      if (os.contains("win")) {
         String appData = System.getenv("APPDATA");
         dir = new File(appData != null ? appData : home, "Jalog");
      } else if (os.contains("mac")) {
         dir = new File(home, "Library/Application Support/Jalog");
      } else {
         String xdgConfig = System.getenv("XDG_CONFIG_HOME");
         dir = new File(xdgConfig != null ? xdgConfig : home + "/.config", "jalog");
      }
      dir.mkdirs();
      return dir;
   }
